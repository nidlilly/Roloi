...
import static io.esper.roloi.weekview.WeekViewUtil.isSameDay;
import static io.esper.roloi.weekview.WeekViewUtil.today;
...
//        }
    ...
    private void getMoreEvents(Calendar day) {
        ...
        // If a refresh was requested then reset some variables. REFRESH HERE
        if (mRefreshEvents) {
            mEventRects.clear();
